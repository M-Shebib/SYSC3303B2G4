...
public class Scheduler {
	...
	public synchronized void moveElevatorToDestination(int elevatorNumber, int destination) {
		while (elevators.get(elevatorNumber).currentFloor != destination) {
		...
		System.out.println("Scheduler: Elevator " + (elevatorNumber + 1) + " has reached destination floor " + destination);
	}
