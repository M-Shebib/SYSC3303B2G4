...
-Control : The class is named for being a class which has some shared values that are changed by the threads. As well as having booleans that control which thread runs.
...
-planning : This is a class that explains the purpose of the three subsystems for planning future work.
...
-Test : This class is named for it having a method which tests the subsystems.
